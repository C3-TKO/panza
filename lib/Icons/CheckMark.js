  ...
  _createClass(CheckMark, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          checkMarkIconName = _props.checkMarkIconName,
          uncheckedIconName = _props.uncheckedIconName,
          checkedColor = _props.checkedColor,
          other = _objectWithoutProperties(_props, ['size', 'isChecked', 'uncheckedColor', 'checkMarkIconName', 'uncheckedIconName', 'checkedColor']);

      return _react2.default.createElement(
        _index.Base,
        other,
        isChecked ? _react2.default.createElement(_index.Icon, {
...
CheckMark.propTypes = {
  ...
  uncheckedColor: _react.PropTypes.string,
  checkedColor: _react.PropTypes.string,
  checkMarkIconName: _react.PropTypes.string,
  uncheckedIconName: _react.PropTypes.string
};
