  ...
  _createClass(InputRow, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ['style', 'label', 'value', 'icon', 'height', 'vertical', 'maxLength', 'textAlign', 'customInput']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          customInput || _react2.default.createElement(_index.Input, _extends({
            value: value,
            maxLength: maxLength,
            px: 2,
