...
var RevealOption = function RevealOption(_ref) {
  var label = _ref.label,
      ...
      other = _objectWithoutProperties(_ref, ['label', 'textColor', 'onPress']);
...
var InputRowRevealOptions = function InputRowRevealOptions(_ref2) {
  var options = _ref2.options,
      height = _ref2.height,
      other = _objectWithoutProperties(_ref2, ['options', 'height']);
    ...
    _react2.default.createElement(
      ...
      options.map(function (opt) {
        var label = opt.label,
            ...
            more = _objectWithoutProperties(opt, ['label', 'onPress', 'backgroundColor']);
