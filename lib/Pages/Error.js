  ...
  _createClass(ErrorPage, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          offlineMessage = _props.offlineMessage,
          detailMessage = _props.detailMessage,
          other = _objectWithoutProperties(_props, ['retry', 'message', 'isOffline', 'children', 'offlineMessage', 'detailMessage']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _index.Text,
              { large: true, light: true, textAlign: 'center' },
              message
            )
          ),
          _react2.default.createElement(
            _index.Text,
            { small: true, light: true, textAlign: 'center' },
        ...
        _react2.default.createElement(
          _reactNative.View,
          null,
          !isOffline && retry && _react2.default.createElement(
            _index.Button,
            {
              primary: true,
              onPress: retry
